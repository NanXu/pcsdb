...
$(function() {
	...
	$("#saveUserCloseButton").click(function() {
		window.parent.changeIFrame('${ctx}/system/user/listUsers');
		window.parent.topWin.Dialog.close();
	});
});
...
<body>
	<div style="width:100%;height:100%;">
		<br/>
		<form id="addUserForm" method="post" target="frmright" showOnMouseOver="false">
		    <table class="tableStyle" formMode="line" >
				<tr>
					<td width="25%">用户名</td>
					<td width="75%">
						<input type="text" style="width:70%;" name="username" value="${username }"
						class="validate[required,custom[noSpecialCaracters],exemptString[admin|不允许以admin为用户名],ajax[${ctx }/system/user/isUsernameExist|* 用户名已存在!]] float_left" />
		    ...
		    <center>
		    	<br/>
		    	<button type="button" id="saveUserButton"><span>保存</span></button>&nbsp;&nbsp;&nbsp;&nbsp;
				<button type="button" id="saveUserCloseButton"><span>关闭</span></button>
				<br/>
				<br/>
			</center>
  		</form>
